...
extern c_Game_app* bb_maze_Game;
int bbMain();
...
class c_Level : public Object{
	public:
	c_Image* m_tileset;
	Array<Array<String > > m_tiles;
	c_Level();
	c_Level* m_new();
	int p_load();
	int p_tile_hit(int,int);
	int p_draw();
	void mark();
	String debug();
};
...
String dbg_type(c_Character**p){return "Character";}
int bb_input_KeyHit(int);
int bb_input_KeyDown(int);
bool bb_maze_intersects(int,int,int,int,int,int,int,int);
...
c_Game_app* c_Game_app::m_new(){
	...
	DBG_LOCAL(self,"Self")
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<14>");
	c_App::m_new();
	return this;
}
int c_Game_app::p_OnCreate(){
	...
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<28>");
	bb_audio_PlayMusic(String(L"waittobeking.ogg",16),1);
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<29>");
	bb_app_SetUpdateRate(60);
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<30>");
	gc_assign(m_menu,bb_graphics_LoadImage(String(L"menu.png",8),1,c_Image::m_DefaultFlags));
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<31>");
	gc_assign(m_maze,(new c_Level)->m_new());
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<32>");
	m_maze->p_load();
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<33>");
	gc_assign(m_characters,bb_graphics_LoadImage(String(L"characters.png",14),1,c_Image::m_DefaultFlags));
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<34>");
	gc_assign(m_p1,(new c_Character)->m_new());
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<35>");
	gc_assign(m_p1->m_sprite,m_characters->p_GrabImage(0,0,32,32,1,c_Image::m_DefaultFlags));
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<36>");
	gc_assign(m_ghost,(new c_Character)->m_new());
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<37>");
	gc_assign(m_ghost->m_sprite,m_characters->p_GrabImage(32,0,32,32,1,c_Image::m_DefaultFlags));
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<38>");
	gc_assign(m_gameover,bb_graphics_LoadImage(String(L"gameover.png",12),1,c_Image::m_DefaultFlags));
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<39>");
	gc_assign(m_key,(new c_Character)->m_new());
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<40>");
	gc_assign(m_key->m_sprite,m_characters->p_GrabImage(32,0,32,32,1,c_Image::m_DefaultFlags));
	return 0;
}
...
int c_Game_app::p_OnUpdate(){
	...
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<45>");
	String t_1=m_GameState;
	DBG_LOCAL(t_1,"1")
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<46>");
	if(t_1==String(L"GAMEOVER",8)){
		DBG_BLOCK();
	}else{
		DBG_BLOCK();
		DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<47>");
		if(t_1==String(L"MENU",4)){
			DBG_BLOCK();
			DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<48>");
			...
			DBG_BLOCK();
			DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<49>");
			if(t_1==String(L"INITIALISE",10)){
				DBG_BLOCK();
				DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<50>");
				m_p1->m_x=288;
				DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<51>");
				m_p1->m_y=256;
				DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<52>");
				m_p1->m_speed=4;
				DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<53>");
				m_p1->m_speed_x=m_p1->m_speed;
				DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<54>");
				m_p1->m_speed_y=0;
				DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<55>");
				m_ghost->m_x=0;
				DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<56>");
				m_ghost->m_y=0;
				DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<57>");
				m_ghost->m_speed=2;
				DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<58>");
				m_key->m_x=8;
				DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<59>");
				m_key->m_y=8;
				DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<60>");
				m_GameState=String(L"PLAYING",7);
			}else{
				DBG_BLOCK();
				DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<61>");
				if(t_1==String(L"PLAYING",7)){
					DBG_BLOCK();
					DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<63>");
					if((bb_input_KeyHit(27))!=0){
						DBG_BLOCK();
						m_GameState=String(L"MENU",4);
					}
					DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<64>");
					if((bb_input_KeyDown(37))!=0){
						DBG_BLOCK();
						DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<65>");
						m_p1->m_speed_x=-m_p1->m_speed;
						DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<66>");
						for(int t_i=0;t_i<=1;t_i=t_i+1){
							DBG_BLOCK();
							DBG_LOCAL(t_i,"i")
							DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<67>");
							if(m_ghost->m_x<m_p1->m_x){
								DBG_BLOCK();
								m_ghost->m_x+=m_ghost->m_speed;
							}
							DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<68>");
							if(m_ghost->m_x>m_p1->m_x){
								DBG_BLOCK();
								m_ghost->m_x-=m_ghost->m_speed;
							}
							DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<69>");
							if(m_ghost->m_y<m_p1->m_y){
								DBG_BLOCK();
								m_ghost->m_y+=m_ghost->m_speed;
							}
							DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<70>");
							if(m_ghost->m_y>m_p1->m_y){
								DBG_BLOCK();
								m_ghost->m_y-=m_ghost->m_speed;
							}
							DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<71>");
							if(bb_maze_intersects(m_p1->m_x,m_p1->m_y,32,32,m_ghost->m_x,m_ghost->m_y,32,32)){
								DBG_BLOCK();
								m_GameState=String(L"GAMEOVER",8);
							}
						}
					}
					DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<75>");
					if((bb_input_KeyDown(39))!=0){
						DBG_BLOCK();
						DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<76>");
						m_p1->m_speed_x=m_p1->m_speed;
					}
					DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<79>");
					if((bb_input_KeyDown(38))!=0){
						DBG_BLOCK();
						DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<80>");
						m_p1->m_speed_y=-m_p1->m_speed;
					}
					DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<83>");
					if((bb_input_KeyDown(40))!=0){
						DBG_BLOCK();
						DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<84>");
						m_p1->m_speed_y=m_p1->m_speed;
					}
					DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<87>");
					m_p1->m_x+=m_p1->m_speed_x;
					DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<89>");
					if(m_maze->p_tile_hit(m_p1->m_x,m_p1->m_y)==1){
						DBG_BLOCK();
						DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<90>");
						m_p1->m_x-=m_p1->m_speed_x;
						DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<91>");
						m_p1->m_speed_x=0;
					}
					DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<93>");
					m_p1->m_y+=m_p1->m_speed_y;
					DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<94>");
					if(m_maze->p_tile_hit(m_p1->m_x,m_p1->m_y)==1){
						DBG_BLOCK();
						DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<95>");
						m_p1->m_y-=m_p1->m_speed_y;
						DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<96>");
						m_p1->m_speed_y=0;
					}
				}
			}
...
int c_Game_app::p_OnRender(){
	...
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<103>");
	String t_2=m_GameState;
	DBG_LOCAL(t_2,"2")
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<104>");
	if(t_2==String(L"MENU",4)){
		DBG_BLOCK();
		DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<105>");
		bb_graphics_DrawImage(m_menu,FLOAT(0.0),FLOAT(0.0),0);
	}else{
		DBG_BLOCK();
		DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<106>");
		if(t_2==String(L"GAMEOVER",8)){
			DBG_BLOCK();
			DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<107>");
			bb_graphics_DrawImage(m_gameover,FLOAT(0.0),FLOAT(0.0),0);
		}else{
			DBG_BLOCK();
			DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<108>");
			if(t_2==String(L"PLAYING",7)){
				DBG_BLOCK();
				DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<109>");
				bb_graphics_Cls(FLOAT(0.0),FLOAT(0.0),FLOAT(0.0));
				DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<110>");
				m_maze->p_draw();
				DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<111>");
				m_p1->p_draw();
				DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<112>");
				m_ghost->p_draw();
				DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<113>");
				m_key->p_draw();
			}
		}
	}
...
String c_Game_app::debug(){
	...
	t+=dbg_decl("maze",&m_maze);
	t+=dbg_decl("characters",&m_characters);
	t+=dbg_decl("p1",&m_p1);
	t+=dbg_decl("ghost",&m_ghost);
...
BBGame* bb_app__game;
c_Game_app* bb_maze_Game;
int bbMain(){
	DBG_ENTER("Main")
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<10>");
	gc_assign(bb_maze_Game,(new c_Game_app)->m_new());
	return 0;
}
...
c_Level::c_Level(){
	m_tileset=0;
	m_tiles=Array<Array<String > >(21);
}
c_Level* c_Level::m_new(){
	DBG_ENTER("Level.new")
	c_Level *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<123>");
	gc_assign(m_tileset,bb_graphics_LoadImage2(String(L"tiles.png",9),32,32,3,c_Image::m_DefaultFlags));
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<124>");
	for(int t_i=0;t_i<=20;t_i=t_i+1){
		DBG_BLOCK();
		DBG_LOCAL(t_i,"i")
		DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<125>");
		gc_assign(m_tiles.At(t_i),Array<String >(16));
	}
	return this;
}
int c_Level::p_load(){
	DBG_ENTER("Level.load")
	c_Level *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<130>");
	c_FileStream* t_level_file=0;
	DBG_LOCAL(t_level_file,"level_file")
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<131>");
	String t_level_data=String();
	DBG_LOCAL(t_level_data,"level_data")
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<132>");
	Array<String > t_data_item=Array<String >();
	DBG_LOCAL(t_data_item,"data_item")
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<134>");
	t_level_file=c_FileStream::m_Open(String(L"monkey://data/maze.txt",22),String(L"r",1));
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<135>");
	t_level_data=t_level_file->p_ReadString2(String(L"utf8",4));
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<136>");
	t_level_file->p_Close();
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<138>");
	t_data_item=t_level_data.Split(String(L"\n",1));
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<139>");
	for(int t_y=0;t_y<=14;t_y=t_y+1){
		DBG_BLOCK();
		DBG_LOCAL(t_y,"y")
		DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<140>");
		for(int t_x=0;t_x<=19;t_x=t_x+1){
			DBG_BLOCK();
			DBG_LOCAL(t_x,"x")
			DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<141>");
			m_tiles.At(t_x).At(t_y)=String((t_data_item.At(t_y).Slice(t_x,t_x+1)).ToInt());
		}
	}
	return 0;
}
int c_Level::p_tile_hit(int t_x,int t_y){
	DBG_ENTER("Level.tile_hit")
	c_Level *self=this;
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_x,"x")
	DBG_LOCAL(t_y,"y")
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<159>");
	int t_left_tile=t_x/32;
	DBG_LOCAL(t_left_tile,"left_tile")
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<160>");
	int t_right_tile=(t_x+31)/32;
	DBG_LOCAL(t_right_tile,"right_tile")
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<161>");
	int t_top_tile=t_y/32;
	DBG_LOCAL(t_top_tile,"top_tile")
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<162>");
	int t_bottom_tile=(t_y+31)/32;
	DBG_LOCAL(t_bottom_tile,"bottom_tile")
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<164>");
	if(t_left_tile<0){
		DBG_BLOCK();
		t_left_tile=0;
	}
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<165>");
	if(t_right_tile>19){
		DBG_BLOCK();
		t_right_tile=19;
	}
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<166>");
	if(t_top_tile<0){
		DBG_BLOCK();
		t_top_tile=0;
	}
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<167>");
	if(t_bottom_tile>14){
		DBG_BLOCK();
		t_bottom_tile=14;
	}
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<169>");
	int t_collision_result=0;
	DBG_LOCAL(t_collision_result,"collision_result")
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<170>");
	for(int t_i=t_left_tile;t_i<=t_right_tile;t_i=t_i+1){
		DBG_BLOCK();
		DBG_LOCAL(t_i,"i")
		DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<171>");
		for(int t_j=t_top_tile;t_j<=t_bottom_tile;t_j=t_j+1){
			DBG_BLOCK();
			DBG_LOCAL(t_j,"j")
			DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<172>");
			if(m_tiles.At(t_i).At(t_j)==String(L"1",1)){
				DBG_BLOCK();
				t_collision_result=1;
			}
		}
	}
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<175>");
	return t_collision_result;
}
int c_Level::p_draw(){
	DBG_ENTER("Level.draw")
	c_Level *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<147>");
	String t_tile=String();
	DBG_LOCAL(t_tile,"tile")
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<148>");
	for(int t_y=0;t_y<=14;t_y=t_y+1){
		DBG_BLOCK();
		DBG_LOCAL(t_y,"y")
		DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<149>");
		for(int t_x=0;t_x<=19;t_x=t_x+1){
			DBG_BLOCK();
			DBG_LOCAL(t_x,"x")
			DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<150>");
			t_tile=m_tiles.At(t_x).At(t_y);
			DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<151>");
			if(t_tile==String(L"1",1)){
				DBG_BLOCK();
				bb_graphics_DrawImage(m_tileset,Float(t_x*32),Float(t_y*32),1);
			}
			DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<152>");
			if(t_tile==String(L"2",1)){
				DBG_BLOCK();
				bb_graphics_DrawImage(m_tileset,Float(t_x*32),Float(t_y*32),2);
			}
		}
	}
	return 0;
...
c_Stream* c_Stream::m_new(){
	...
	c_Stream *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<31>");
	return this;
}
void c_Stream::p_ReadError(){
	...
	c_Stream *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<188>");
...
void c_Stream::p_ReadAll(c_DataBuffer* t_buffer,int t_offset,int t_count){
	...
	DBG_LOCAL(t_offset,"offset")
	DBG_LOCAL(t_count,"count")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<48>");
	while(t_count>0){
		DBG_BLOCK();
		DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<49>");
		int t_n=p_Read(t_buffer,t_offset,t_count);
		DBG_LOCAL(t_n,"n")
		DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<50>");
		if(t_n<=0){
			DBG_BLOCK();
			p_ReadError();
		}
		DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<51>");
		t_offset+=t_n;
		DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<52>");
		t_count-=t_n;
	}
}
c_DataBuffer* c_Stream::p_ReadAll2(){
	...
	c_Stream *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<57>");
	c_Stack2* t_bufs=(new c_Stack2)->m_new();
	DBG_LOCAL(t_bufs,"bufs")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<58>");
	...
	DBG_LOCAL(t_off,"off")
	DBG_LOCAL(t_len,"len")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<59>");
	do{
		DBG_BLOCK();
		DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<60>");
		int t_n=p_Read(t_buf,t_off,4096-t_off);
		DBG_LOCAL(t_n,"n")
		DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<61>");
		if(t_n<=0){
			DBG_BLOCK();
			break;
		}
		DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<62>");
		t_off+=t_n;
		DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<63>");
		t_len+=t_n;
		DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<64>");
		if(t_off==4096){
			DBG_BLOCK();
			DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<65>");
			t_off=0;
			DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<66>");
			t_bufs->p_Push4(t_buf);
			DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<67>");
			t_buf=(new c_DataBuffer)->m_new(4096);
		}
	}while(!(false));
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<70>");
	c_DataBuffer* t_data=(new c_DataBuffer)->m_new(t_len);
	DBG_LOCAL(t_data,"data")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<71>");
	t_off=0;
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<72>");
	c_Enumerator* t_=t_bufs->p_ObjectEnumerator();
	while(t_->p_HasNext()){
		DBG_BLOCK();
		c_DataBuffer* t_tbuf=t_->p_NextObject();
		DBG_LOCAL(t_tbuf,"tbuf")
		DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<73>");
		t_tbuf->p_CopyBytes(0,t_data,t_off,4096);
		DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<74>");
		t_tbuf->Discard();
		DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<75>");
		t_off+=4096;
	}
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<77>");
	t_buf->p_CopyBytes(0,t_data,t_off,t_len-t_off);
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<78>");
	t_buf->Discard();
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<79>");
	return t_data;
}
String c_Stream::p_ReadString(int t_count,String t_encoding){
	...
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<120>");
	c_DataBuffer* t_buf=(new c_DataBuffer)->m_new(t_count);
	DBG_LOCAL(t_buf,"buf")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<121>");
	p_ReadAll(t_buf,0,t_count);
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<122>");
...
String c_Stream::p_ReadString2(String t_encoding){
	...
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_encoding,"encoding")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<126>");
	c_DataBuffer* t_buf=p_ReadAll2();
	DBG_LOCAL(t_buf,"buf")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<127>");
	String t_=t_buf->p_PeekString2(0,t_encoding);
	return t_;
}
void c_Stream::mark(){
...
BBFileStream* c_FileStream::m_OpenStream(String t_path,String t_mode){
	...
	DBG_LOCAL(t_path,"path")
	DBG_LOCAL(t_mode,"mode")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/filestream.monkey<79>");
	BBFileStream* t_stream=(new BBFileStream);
	DBG_LOCAL(t_stream,"stream")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/filestream.monkey<80>");
	String t_fmode=t_mode;
	DBG_LOCAL(t_fmode,"fmode")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/filestream.monkey<81>");
	if(t_fmode==String(L"a",1)){
		DBG_BLOCK();
		t_fmode=String(L"u",1);
	}
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/filestream.monkey<82>");
	if(!t_stream->Open(t_path,t_fmode)){
		DBG_BLOCK();
		return 0;
	}
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/filestream.monkey<83>");
	if(t_mode==String(L"a",1)){
		DBG_BLOCK();
		t_stream->Seek(t_stream->Length());
	}
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/filestream.monkey<84>");
	return t_stream;
}
c_FileStream* c_FileStream::m_new(String t_path,String t_mode){
	...
	DBG_LOCAL(t_path,"path")
	DBG_LOCAL(t_mode,"mode")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/filestream.monkey<31>");
	c_Stream::m_new();
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/filestream.monkey<32>");
	gc_assign(m__stream,m_OpenStream(t_path,t_mode));
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/filestream.monkey<33>");
	if(!((m__stream)!=0)){
		DBG_BLOCK();
...
c_FileStream* c_FileStream::m_new2(BBFileStream* t_stream){
	...
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_stream,"stream")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/filestream.monkey<74>");
	c_Stream::m_new();
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/filestream.monkey<75>");
...
c_FileStream* c_FileStream::m_new3(){
	...
	c_FileStream *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/filestream.monkey<29>");
	c_Stream::m_new();
	return this;
}
c_FileStream* c_FileStream::m_Open(String t_path,String t_mode){
	...
	DBG_LOCAL(t_path,"path")
	DBG_LOCAL(t_mode,"mode")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/filestream.monkey<67>");
	BBFileStream* t_stream=m_OpenStream(t_path,t_mode);
	DBG_LOCAL(t_stream,"stream")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/filestream.monkey<68>");
	if((t_stream)!=0){
		DBG_BLOCK();
		c_FileStream* t_=(new c_FileStream)->m_new2(t_stream);
		return t_;
	}
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/filestream.monkey<69>");
	return 0;
}
void c_FileStream::p_Close(){
	...
	c_FileStream *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/filestream.monkey<37>");
	if(!((m__stream)!=0)){
		DBG_BLOCK();
		return;
	}
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/filestream.monkey<38>");
	m__stream->Close();
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/filestream.monkey<39>");
	m__stream=0;
}
int c_FileStream::p_Read(c_DataBuffer* t_buffer,int t_offset,int t_count){
	...
	DBG_LOCAL(t_offset,"offset")
	DBG_LOCAL(t_count,"count")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/filestream.monkey<59>");
...
c_DataBuffer* c_DataBuffer::m_new(int t_length){
	...
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<94>");
	if(!_New(t_length)){
		DBG_BLOCK();
...
c_DataBuffer* c_DataBuffer::m_new2(){
	...
	c_DataBuffer *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<91>");
	return this;
}
void c_DataBuffer::p_CopyBytes(int t_address,c_DataBuffer* t_dst,int t_dstaddress,int t_count){
	...
	DBG_LOCAL(t_count,"count")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<114>");
	if(t_address+t_count>Length()){
		DBG_BLOCK();
		t_count=Length()-t_address;
	}
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<115>");
	if(t_dstaddress+t_count>t_dst->Length()){
		DBG_BLOCK();
		t_count=t_dst->Length()-t_dstaddress;
	}
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<117>");
	if(t_dstaddress<=t_address){
		DBG_BLOCK();
		DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<118>");
		for(int t_i=0;t_i<t_count;t_i=t_i+1){
			DBG_BLOCK();
			DBG_LOCAL(t_i,"i")
			DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<119>");
			t_dst->PokeByte(t_dstaddress+t_i,PeekByte(t_address+t_i));
		}
	}else{
		DBG_BLOCK();
		DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<122>");
		for(int t_i2=t_count-1;t_i2>=0;t_i2=t_i2+-1){
			DBG_BLOCK();
			DBG_LOCAL(t_i2,"i")
			DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<123>");
...
void c_DataBuffer::p_PeekBytes(int t_address,Array<int > t_bytes,int t_offset,int t_count){
	...
	DBG_LOCAL(t_offset,"offset")
	DBG_LOCAL(t_count,"count")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<137>");
	if(t_address+t_count>Length()){
		DBG_BLOCK();
		t_count=Length()-t_address;
	}
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<138>");
	if(t_offset+t_count>t_bytes.Length()){
		DBG_BLOCK();
		t_count=t_bytes.Length()-t_offset;
	}
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<139>");
	for(int t_i=0;t_i<t_count;t_i=t_i+1){
		DBG_BLOCK();
		DBG_LOCAL(t_i,"i")
		DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<140>");
...
Array<int > c_DataBuffer::p_PeekBytes2(int t_address,int t_count){
	...
	DBG_LOCAL(t_address,"address")
	DBG_LOCAL(t_count,"count")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<130>");
	if(t_address+t_count>Length()){
		DBG_BLOCK();
		t_count=Length()-t_address;
	}
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<131>");
	Array<int > t_bytes=Array<int >(t_count);
	DBG_LOCAL(t_bytes,"bytes")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<132>");
	p_PeekBytes(t_address,t_bytes,0,t_count);
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<133>");
	return t_bytes;
}
String c_DataBuffer::p_PeekString(int t_address,int t_count,String t_encoding){
	...
	DBG_LOCAL(t_count,"count")
	DBG_LOCAL(t_encoding,"encoding")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<206>");
	String t_1=t_encoding;
	DBG_LOCAL(t_1,"1")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<207>");
	if(t_1==String(L"utf8",4)){
		DBG_BLOCK();
		DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<208>");
		Array<int > t_p=p_PeekBytes2(t_address,t_count);
		DBG_LOCAL(t_p,"p")
		DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<209>");
		int t_i=0;
		int t_e=t_p.Length();
		bool t_err=false;
		DBG_LOCAL(t_i,"i")
		DBG_LOCAL(t_e,"e")
		DBG_LOCAL(t_err,"err")
		DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<210>");
		Array<int > t_q=Array<int >(t_e);
		int t_j=0;
		DBG_LOCAL(t_q,"q")
		DBG_LOCAL(t_j,"j")
		DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<211>");
		while(t_i<t_e){
			DBG_BLOCK();
			DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<212>");
			int t_c=t_p.At(t_i)&255;
			DBG_LOCAL(t_c,"c")
			DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<213>");
			t_i+=1;
			DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<214>");
			if((t_c&128)!=0){
				DBG_BLOCK();
				DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<215>");
				if((t_c&224)==192){
					DBG_BLOCK();
					DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<216>");
					if(t_i>=t_e || (t_p.At(t_i)&192)!=128){
						DBG_BLOCK();
						DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<217>");
						t_err=true;
						DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<218>");
						break;
					}
					DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<220>");
					t_c=(t_c&31)<<6|t_p.At(t_i)&63;
					DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<221>");
					t_i+=1;
				}else{
					DBG_BLOCK();
					DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<222>");
					if((t_c&240)==224){
						DBG_BLOCK();
						DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<223>");
						if(t_i+1>=t_e || (t_p.At(t_i)&192)!=128 || (t_p.At(t_i+1)&192)!=128){
							DBG_BLOCK();
							DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<224>");
							t_err=true;
							DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<225>");
							break;
						}
						DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<227>");
						t_c=(t_c&15)<<12|(t_p.At(t_i)&63)<<6|t_p.At(t_i+1)&63;
						DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<228>");
						t_i+=2;
					}else{
						DBG_BLOCK();
						DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<230>");
						t_err=true;
						DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<231>");
						break;
					}
				}
			}
			DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<234>");
			t_q.At(t_j)=t_c;
			DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<235>");
			t_j+=1;
		}
		DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<237>");
		if(t_err){
			DBG_BLOCK();
			DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<239>");
			String t_=String::FromChars(t_p);
			return t_;
		}
		DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<241>");
		if(t_j<t_e){
			DBG_BLOCK();
			t_q=t_q.Slice(0,t_j);
		}
		DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<242>");
		String t_2=String::FromChars(t_q);
		return t_2;
	}else{
		DBG_BLOCK();
		DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<243>");
		if(t_1==String(L"ascii",5)){
			DBG_BLOCK();
			DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<244>");
			Array<int > t_p2=p_PeekBytes2(t_address,t_count);
			DBG_LOCAL(t_p2,"p")
			DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<245>");
			for(int t_i2=0;t_i2<t_p2.Length();t_i2=t_i2+1){
				DBG_BLOCK();
				DBG_LOCAL(t_i2,"i")
				DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<246>");
				t_p2.At(t_i2)&=255;
			}
			DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<248>");
			String t_3=String::FromChars(t_p2);
			return t_3;
		}
	}
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<251>");
...
String c_DataBuffer::p_PeekString2(int t_address,String t_encoding){
	...
	DBG_LOCAL(t_address,"address")
	DBG_LOCAL(t_encoding,"encoding")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/databuffer.monkey<201>");
...
c_StreamError* c_StreamError::m_new(c_Stream* t_stream){
	...
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_stream,"stream")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<200>");
	gc_assign(m__stream,t_stream);
	return this;
}
c_StreamError* c_StreamError::m_new2(){
	...
	c_StreamError *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<197>");
	return this;
}
...
c_StreamReadError* c_StreamReadError::m_new(c_Stream* t_stream){
	...
	DBG_LOCAL(self,"Self")
	DBG_LOCAL(t_stream,"stream")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<217>");
...
c_StreamReadError* c_StreamReadError::m_new2(){
	...
	c_StreamReadError *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/brl/stream.monkey<214>");
	c_StreamError::m_new2();
	return this;
}
...
c_Enumerator* c_Stack2::p_ObjectEnumerator(){
	...
	c_Stack2 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/monkey/stack.monkey<188>");
...
void c_Stack2::p_Length(int t_newlength){
	...
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/monkey/stack.monkey<45>");
	if(t_newlength<m_length){
		DBG_BLOCK();
		DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/monkey/stack.monkey<46>");
		for(int t_i=t_newlength;t_i<m_length;t_i=t_i+1){
			DBG_BLOCK();
			DBG_LOCAL(t_i,"i")
			DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/monkey/stack.monkey<47>");
			gc_assign(m_data.At(t_i),m_NIL);
		}
	}else{
		DBG_BLOCK();
		DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/monkey/stack.monkey<49>");
		if(t_newlength>m_data.Length()){
			DBG_BLOCK();
			DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/monkey/stack.monkey<50>");
			gc_assign(m_data,m_data.Resize(bb_math_Max(m_length*2+10,t_newlength)));
		}
	}
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/monkey/stack.monkey<52>");
...
int c_Stack2::p_Length2(){
	...
	c_Stack2 *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/monkey/stack.monkey<56>");
	return m_length;
}
void c_Stack2::mark(){
	Object::mark();
...
c_Enumerator* c_Enumerator::m_new(c_Stack2* t_stack){
	...
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/monkey/stack.monkey<259>");
...
c_Enumerator* c_Enumerator::m_new2(){
	...
	c_Enumerator *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/monkey/stack.monkey<256>");
	return this;
}
bool c_Enumerator::p_HasNext(){
	...
	c_Enumerator *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/monkey/stack.monkey<263>");
...
c_DataBuffer* c_Enumerator::p_NextObject(){
	...
	c_Enumerator *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/monkey/stack.monkey<267>");
	m_index+=1;
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/monkey/stack.monkey<268>");
...
int bb_math_Max(int t_x,int t_y){
	...
	DBG_LOCAL(t_x,"x")
	DBG_LOCAL(t_y,"y")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/monkey/math.monkey<56>");
	if(t_x>t_y){
		DBG_BLOCK();
		return t_x;
	}
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/monkey/math.monkey<57>");
	return t_y;
}
Float bb_math_Max2(Float t_x,Float t_y){
	...
	DBG_LOCAL(t_x,"x")
	DBG_LOCAL(t_y,"y")
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/monkey/math.monkey<83>");
	if(t_x>t_y){
		DBG_BLOCK();
		return t_x;
	}
	DBG_INFO("C:/Program Files (x86)/MonkeyX/modules/monkey/math.monkey<84>");
	return t_y;
}
...
c_Character* c_Character::m_new(){
	DBG_ENTER("Character.new")
	c_Character *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<180>");
	return this;
}
int c_Character::p_draw(){
	DBG_ENTER("Character.draw")
	c_Character *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<189>");
	bb_graphics_DrawImage(m_sprite,Float(m_x),Float(m_y),0);
	return 0;
}
...
String c_Character::debug(){
	String t="(Character)\n";
	t+=dbg_decl("sprite",&m_sprite);
	t+=dbg_decl("x",&m_x);
	t+=dbg_decl("y",&m_y);
	t+=dbg_decl("speed",&m_speed);
	t+=dbg_decl("speed_x",&m_speed_x);
	t+=dbg_decl("speed_y",&m_speed_y);
	return t;
}
...
bool bb_maze_intersects(int t_x1,int t_y1,int t_w1,int t_h1,int t_x2,int t_y2,int t_w2,int t_h2){
	...
	DBG_LOCAL(t_w2,"w2")
	DBG_LOCAL(t_h2,"h2")
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<194>");
	if(t_x1>=t_x2+t_w2 || t_x1+t_w1<=t_x2){
		DBG_BLOCK();
		return false;
	}
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<195>");
	if(t_y1>=t_y2+t_h2 || t_y1+t_h1<=t_y2){
		DBG_BLOCK();
		return false;
	}
	DBG_INFO("E:/Year 13/CS Stall/Maze/maze.monkey<196>");
	return true;
}
int bb_graphics_DebugRenderDevice(){
