...
c_Game_app* c_Game_app::m_new(){
	...
	DBG_LOCAL(self,"Self")
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<14>");
	c_App::m_new();
	return this;
}
...
int c_Game_app::p_OnUpdate(){
	...
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<45>");
	String t_1=m_GameState;
	DBG_LOCAL(t_1,"1")
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<46>");
	if(t_1==String(L"GAMEOVER",8)){
		DBG_BLOCK();
	}else{
		DBG_BLOCK();
		DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<47>");
		if(t_1==String(L"MENU",4)){
			DBG_BLOCK();
			DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<48>");
			...
			DBG_BLOCK();
			DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<49>");
			if(t_1==String(L"INITIALISE",10)){
				DBG_BLOCK();
				DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<50>");
				m_p1->m_x=288;
				DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<51>");
				m_p1->m_y=256;
				DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<52>");
				m_p1->m_speed=4;
				DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<53>");
				m_p1->m_speed_x=m_p1->m_speed;
				DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<54>");
				m_p1->m_speed_y=0;
				DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<55>");
				m_ghost->m_x=0;
				DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<56>");
				m_ghost->m_y=0;
				DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<57>");
				m_ghost->m_speed=2;
				DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<58>");
				m_key->m_x=8;
				DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<59>");
				m_key->m_y=8;
				DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<60>");
				m_GameState=String(L"PLAYING",7);
			}else{
				DBG_BLOCK();
				DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<61>");
				if(t_1==String(L"PLAYING",7)){
					DBG_BLOCK();
					DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<63>");
					if((bb_input_KeyHit(27))!=0){
						DBG_BLOCK();
						m_GameState=String(L"MENU",4);
					}
					DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<64>");
					if((bb_input_KeyDown(37))!=0){
						DBG_BLOCK();
						DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<65>");
						m_p1->m_speed_x=-m_p1->m_speed;
						DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<66>");
						for(int t_i=0;t_i<=1;t_i=t_i+1){
							DBG_BLOCK();
							DBG_LOCAL(t_i,"i")
							DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<67>");
							if(m_ghost->m_x<m_p1->m_x){
								DBG_BLOCK();
								m_ghost->m_x+=m_ghost->m_speed;
							}
							DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<68>");
							if(m_ghost->m_x>m_p1->m_x){
								DBG_BLOCK();
								m_ghost->m_x-=m_ghost->m_speed;
							}
							DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<69>");
							if(m_ghost->m_y<m_p1->m_y){
								DBG_BLOCK();
								m_ghost->m_y+=m_ghost->m_speed;
							}
							DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<70>");
							if(m_ghost->m_y>m_p1->m_y){
								DBG_BLOCK();
								m_ghost->m_y-=m_ghost->m_speed;
							}
							DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<71>");
					...
					DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<75>");
					if((bb_input_KeyDown(39))!=0){
						DBG_BLOCK();
						DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<76>");
						m_p1->m_speed_x=m_p1->m_speed;
					}
					DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<79>");
					if((bb_input_KeyDown(38))!=0){
						DBG_BLOCK();
						DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<80>");
						m_p1->m_speed_y=-m_p1->m_speed;
					}
					DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<83>");
					if((bb_input_KeyDown(40))!=0){
						DBG_BLOCK();
						DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<84>");
						m_p1->m_speed_y=m_p1->m_speed;
					}
					DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<87>");
					m_p1->m_x+=m_p1->m_speed_x;
					DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<89>");
					if(m_maze->p_tile_hit(m_p1->m_x,m_p1->m_y)==1){
						DBG_BLOCK();
						DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<90>");
						m_p1->m_x-=m_p1->m_speed_x;
						DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<91>");
						m_p1->m_speed_x=0;
					}
					DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<93>");
					m_p1->m_y+=m_p1->m_speed_y;
					DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<94>");
					if(m_maze->p_tile_hit(m_p1->m_x,m_p1->m_y)==1){
						DBG_BLOCK();
						DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<95>");
						m_p1->m_y-=m_p1->m_speed_y;
						DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<96>");
						m_p1->m_speed_y=0;
					}
				}
			}
...
int c_Game_app::p_OnRender(){
	...
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<103>");
	String t_2=m_GameState;
	DBG_LOCAL(t_2,"2")
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<104>");
	if(t_2==String(L"MENU",4)){
		DBG_BLOCK();
		DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<105>");
		bb_graphics_DrawImage(m_menu,FLOAT(0.0),FLOAT(0.0),0);
	}else{
		DBG_BLOCK();
		DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<106>");
		if(t_2==String(L"GAMEOVER",8)){
			DBG_BLOCK();
			DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<107>");
			bb_graphics_DrawImage(m_gameover,FLOAT(0.0),FLOAT(0.0),0);
		}else{
			DBG_BLOCK();
			DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<108>");
			if(t_2==String(L"PLAYING",7)){
				DBG_BLOCK();
				DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<109>");
				bb_graphics_Cls(FLOAT(0.0),FLOAT(0.0),FLOAT(0.0));
				DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<110>");
				m_maze->p_draw();
				DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<111>");
				m_p1->p_draw();
				DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<112>");
				m_ghost->p_draw();
				DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<113>");
				m_key->p_draw();
			}
		}
	}
...
int bbMain(){
	DBG_ENTER("Main")
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<10>");
...
c_Level* c_Level::m_new(){
	...
	c_Level *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<123>");
	gc_assign(m_tileset,bb_graphics_LoadImage2(String(L"tiles.png",9),32,32,3,c_Image::m_DefaultFlags));
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<124>");
	for(int t_i=0;t_i<=20;t_i=t_i+1){
		DBG_BLOCK();
		DBG_LOCAL(t_i,"i")
		DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<125>");
...
int c_Level::p_load(){
	...
	c_Level *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<130>");
	c_FileStream* t_level_file=0;
	DBG_LOCAL(t_level_file,"level_file")
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<131>");
	String t_level_data=String();
	DBG_LOCAL(t_level_data,"level_data")
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<132>");
	Array<String > t_data_item=Array<String >();
	DBG_LOCAL(t_data_item,"data_item")
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<134>");
	t_level_file=c_FileStream::m_Open(String(L"monkey://data/maze.txt",22),String(L"r",1));
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<135>");
	t_level_data=t_level_file->p_ReadString2(String(L"utf8",4));
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<136>");
	t_level_file->p_Close();
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<138>");
	t_data_item=t_level_data.Split(String(L"\n",1));
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<139>");
	for(int t_y=0;t_y<=14;t_y=t_y+1){
		DBG_BLOCK();
		DBG_LOCAL(t_y,"y")
		DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<140>");
		for(int t_x=0;t_x<=19;t_x=t_x+1){
			DBG_BLOCK();
			DBG_LOCAL(t_x,"x")
			DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<141>");
...
int c_Level::p_tile_hit(int t_x,int t_y){
	...
	DBG_LOCAL(t_x,"x")
	DBG_LOCAL(t_y,"y")
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<159>");
	int t_left_tile=t_x/32;
	DBG_LOCAL(t_left_tile,"left_tile")
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<160>");
	int t_right_tile=(t_x+31)/32;
	DBG_LOCAL(t_right_tile,"right_tile")
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<161>");
	int t_top_tile=t_y/32;
	DBG_LOCAL(t_top_tile,"top_tile")
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<162>");
	int t_bottom_tile=(t_y+31)/32;
	DBG_LOCAL(t_bottom_tile,"bottom_tile")
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<164>");
	if(t_left_tile<0){
		DBG_BLOCK();
		t_left_tile=0;
	}
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<165>");
	if(t_right_tile>19){
		DBG_BLOCK();
		t_right_tile=19;
	}
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<166>");
	if(t_top_tile<0){
		DBG_BLOCK();
		t_top_tile=0;
	}
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<167>");
	if(t_bottom_tile>14){
		DBG_BLOCK();
		t_bottom_tile=14;
	}
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<169>");
	int t_collision_result=0;
	DBG_LOCAL(t_collision_result,"collision_result")
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<170>");
	for(int t_i=t_left_tile;t_i<=t_right_tile;t_i=t_i+1){
		DBG_BLOCK();
		DBG_LOCAL(t_i,"i")
		DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<171>");
		for(int t_j=t_top_tile;t_j<=t_bottom_tile;t_j=t_j+1){
			DBG_BLOCK();
			DBG_LOCAL(t_j,"j")
			DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<172>");
	...
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<175>");
...
int c_Level::p_draw(){
	...
	c_Level *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<147>");
	String t_tile=String();
	DBG_LOCAL(t_tile,"tile")
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<148>");
	for(int t_y=0;t_y<=14;t_y=t_y+1){
		DBG_BLOCK();
		DBG_LOCAL(t_y,"y")
		DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<149>");
		for(int t_x=0;t_x<=19;t_x=t_x+1){
			DBG_BLOCK();
			DBG_LOCAL(t_x,"x")
			DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<150>");
			t_tile=m_tiles.At(t_x).At(t_y);
			DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<151>");
			if(t_tile==String(L"1",1)){
				DBG_BLOCK();
				bb_graphics_DrawImage(m_tileset,Float(t_x*32),Float(t_y*32),1);
			}
			DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<152>");
...
c_Character* c_Character::m_new(){
	...
	DBG_LOCAL(self,"Self")
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<180>");
	return this;
}
int c_Character::p_draw(){
	...
	c_Character *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<189>");
...
bool bb_maze_intersects(int t_x1,int t_y1,int t_w1,int t_h1,int t_x2,int t_y2,int t_w2,int t_h2){
	...
	DBG_LOCAL(t_w2,"w2")
	DBG_LOCAL(t_h2,"h2")
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<194>");
	if(t_x1>=t_x2+t_w2 || t_x1+t_w1<=t_x2){
		DBG_BLOCK();
		return false;
	}
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<195>");
	if(t_y1>=t_y2+t_h2 || t_y1+t_h1<=t_y2){
		DBG_BLOCK();
		return false;
	}
	DBG_INFO("F:/Year 13/CS Stall/Maze/maze.monkey<196>");
	return true;
}
int bb_graphics_DebugRenderDevice(){
