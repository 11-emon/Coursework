...
function c_MyGame(){
	c_App.call(this);
	this.m_enemy_collection=null;
}
c_MyGame.prototype=extend_class(c_App);
c_MyGame.m_new=function(){
	push_err();
	err_info="C:/Users/User/Documents/GitHub/Coursework/balloonmove/balloonmove.monkey<10>";
	c_App.m_new.call(this);
	err_info="C:/Users/User/Documents/GitHub/Coursework/balloonmove/balloonmove.monkey<10>";
	pop_err();
	return this;
}
c_MyGame.m_airballoon=null;
c_MyGame.prototype.p_OnCreate=function(){
	push_err();
	err_info="C:/Users/User/Documents/GitHub/Coursework/balloonmove/balloonmove.monkey<17>";
	bb_app_SetUpdateRate(60);
	err_info="C:/Users/User/Documents/GitHub/Coursework/balloonmove/balloonmove.monkey<18>";
	c_MyGame.m_airballoon=bb_graphics_LoadImage("hotairballoon.png",1,c_Image.m_DefaultFlags);
	pop_err();
	return 0;
}
...
c_MyGame.prototype.p_OnRender=function(){
	push_err();
	err_info="C:/Users/User/Documents/GitHub/Coursework/balloonmove/balloonmove.monkey<35>";
	bb_graphics_Cls(0.0,191.0,255.0);
	err_info="C:/Users/User/Documents/GitHub/Coursework/balloonmove/balloonmove.monkey<37>";
	bb_graphics_DrawImage(c_MyGame.m_airballoon,320.0,220.0,0);
	err_info="C:/Users/User/Documents/GitHub/Coursework/balloonmove/balloonmove.monkey<39>";
	err_info="C:/Users/User/Documents/GitHub/Coursework/balloonmove/balloonmove.monkey<39>";
	var t_=this.m_enemy_collection.p_ObjectEnumerator();
	err_info="C:/Users/User/Documents/GitHub/Coursework/balloonmove/balloonmove.monkey<39>";
	while(t_.p_HasNext()){
		err_info="C:/Users/User/Documents/GitHub/Coursework/balloonmove/balloonmove.monkey<39>";
		var t_enemy=t_.p_NextObject();
		err_info="C:/Users/User/Documents/GitHub/Coursework/balloonmove/balloonmove.monkey<41>";
		if(dbg_object(t_enemy).m_y>400.0){
			err_info="C:/Users/User/Documents/GitHub/Coursework/balloonmove/balloonmove.monkey<42>";
			bb_balloonmove_updowndir="up";
		}
		err_info="C:/Users/User/Documents/GitHub/Coursework/balloonmove/balloonmove.monkey<44>";
		if(dbg_object(t_enemy).m_y<0.0){
			err_info="C:/Users/User/Documents/GitHub/Coursework/balloonmove/balloonmove.monkey<45>";
			bb_balloonmove_updowndir="down";
		}
		err_info="C:/Users/User/Documents/GitHub/Coursework/balloonmove/balloonmove.monkey<48>";
		if(bb_balloonmove_updowndir=="down"){
			err_info="C:/Users/User/Documents/GitHub/Coursework/balloonmove/balloonmove.monkey<49>";
			dbg_object(t_enemy).m_y=dbg_object(t_enemy).m_y+2.0;
		}else{
			err_info="C:/Users/User/Documents/GitHub/Coursework/balloonmove/balloonmove.monkey<52>";
			dbg_object(t_enemy).m_y=dbg_object(t_enemy).m_y-3.0;
		}
		err_info="C:/Users/User/Documents/GitHub/Coursework/balloonmove/balloonmove.monkey<54>";
		print(String(dbg_object(t_enemy).m_y));
		err_info="C:/Users/User/Documents/GitHub/Coursework/balloonmove/balloonmove.monkey<55>";
		bb_graphics_DrawImage(dbg_object(t_enemy).m_sprite,dbg_object(t_enemy).m_x,dbg_object(t_enemy).m_y,0);
	}
	pop_err();
	return 0;
}
...
function bbMain(){
	push_err();
	err_info="C:/Users/User/Documents/GitHub/Coursework/balloonmove/balloonmove.monkey<61>";
...
function c_balloon(){
	Object.call(this);
	this.m_y=.0;
	this.m_sprite=bb_graphics_LoadImage("hotairballoon.png",1,c_Image.m_DefaultFlags);
	this.m_x=.0;
}
function c_List(){
	Object.call(this);
